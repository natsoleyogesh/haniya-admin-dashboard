                                    ...
                                    <tr key={employee.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors duration-150">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-right">
                                            <div className="flex items-center justify-end space-x-2">
                                                <button onClick={() => handleViewSalaries(employee)} className="px-3 py-1.5 text-xs font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 transition-colors">
                                                    View Salaries
                                                </button>
                                                <button onClick={() => handleAddSalary(employee)} className="px-3 py-1.5 text-xs font-medium text-white bg-green-600 rounded-md hover:bg-green-700 transition-colors">
                                                    Add Salary
                                                </button>
                                                <button onClick={() => handleEdit(employee)} className="p-1.5 rounded-md text-indigo-600 hover:bg-indigo-100 dark:text-indigo-400 dark:hover:bg-slate-700 transition-colors" aria-label="Edit">
                                                    <PencilIcon className="w-4 h-4" />
                                                </button>
                                                <button onClick={() => openDeleteModal(employee)} className="p-1.5 rounded-md text-red-600 hover:bg-red-100 dark:text-red-400 dark:hover:bg-slate-700 transition-colors" aria-label="Delete">
